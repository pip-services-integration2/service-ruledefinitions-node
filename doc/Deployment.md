...
```javascript
{
    ...
    "dependencies": {
        ....
        "service-ruledefinitions-node": "^1.1.*",
        ...
    }
}
```
...
var plugin = new require('service-ruledefinitions-node').RuleDefinitionsSenecaPlugin;
...
or by using [RuleDefinitionsSenecaClient](https://github.com/pip-services-integration2/pip-clients-ruledefinitions-node/doc/NodeClientApiV1.md/#client_seneca)